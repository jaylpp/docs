---
title: 'AIGC文本改写'
api: 'POST /api/v1/aigc/rewrite'
description: '使用AI技术对文本进行智能改写，支持降AI率、降重率等多种改写类型'
---

## 接口说明

AIGC 文本改写接口是「熊猫论文」的核心服务，提供基于大语言模型的智能文本改写能力。
...
```bash cURL
curl -X POST https://api.paperpanda.cn/api/v1/aigc/rewrite \
...
url = "https://api.paperpanda.cn/api/v1/aigc/rewrite"
headers = {
    "Authorization": "Bearer ak_xxxxxxxxxxxxxxxx",
...
const rewriteText = async () => {
  try {
    const response = await axios.post(
      'https://api.paperpanda.cn/api/v1/aigc/rewrite',
      {
        content: '人工智能是研究如何使计算机模拟人类智能的一门科学。它包括机器学习、深度学习等多个领域。',
        service_type: 'ai-reduce-value',
        rewrite_type: 1
...
public class AigcRewrite {
    public static void main(String[] args) throws Exception {
        ...
        String url = "https://api.paperpanda.cn/api/v1/aigc/rewrite";
